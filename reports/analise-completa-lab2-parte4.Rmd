...
```{r ETL}
buscas = read_csv(here::here("data/search_data_total.csv")) #TODO lembrar de usar todos os dados
```
...
O gráfico acima mostra que há 25.127 buscas, de um total de 136234, que retornaram nenhum resultado, ou seja, **19%** de todas as buscas retornaram resultado vazio. Desses resultados vazios, 16902 foram do grupo a, que possuem 92056, enquanto 8225 foram do grupo b, que possuem 44178, como podemos ver logo abaixo. Portanto, **18%** das buscas do grupo a e **20%** do grupo b retornaram resultado vazio.
...
merge(total_com_resultado, total_sem_resultado) %>%
    ...
    labs(x = "Grupo", y = "Quantidade de buscas",
         title = "Comparação do total de buscas que retornaram resultado vazio, por grupo")
