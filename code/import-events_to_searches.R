...
#events = events %>% slice(1:10000) # Útil para testar código em dados pequenos. Comente na hora de processá-los para valer.
...
searches = events %>% 
    ...
    summarise(
        ...
        session_last_timestamp = last(timestamp),
        session_last_date = ymd_hms(last(timestamp)),
